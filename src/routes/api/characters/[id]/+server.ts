...
/**
 * Read/write API for character definitions stored as JSON under
 * `static/characters/<id>.json`. The /admin/characters editor calls this to
...
// Definitions live in the static folder so they double as fetchable assets.
const DEFINITIONS_DIR = resolve('static/characters');
