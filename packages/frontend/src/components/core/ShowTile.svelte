<script lang="ts">
	...
	// it, a button inside a button not being markup. The radio is that row's second line now
	// (see MusicLine) and every crumb carries its own tile again — but the split stays, because
