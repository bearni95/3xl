<script lang="ts">
	...
	// room — a song's title on the radio (see MusicLine), which stands under the name of a
	// place in a column 400px wide, and the title is whatever the record is called. An
