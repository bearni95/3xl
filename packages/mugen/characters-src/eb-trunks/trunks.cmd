...
value = 1
;---------------------------------------------------------------------------
[State -1, heatdome attack]
type = changestate
value = 3200
triggerall = !AIlevel&&command = "heatdome"&&roundstate = 2 && statetype != A && power >= 3000
trigger1 = ctrl
trigger2 = (stateno = [200,419])&& movecontact
trigger3 = (stateno = [430,459])&& movecontact
;---------------------------------------------------------------------------
[State -1, final buster]
type = changestate
value = 3100
triggerall = !AIlevel&&command = "finalbuster"&&roundstate = 2 && statetype != A && power >= 2000
trigger1 = ctrl
trigger2 = (stateno = [200,419])&& movecontact
trigger3 = (stateno = [430,459])&& movecontact
;---------------------------------------------------------------------------
[State -1, burning slash]
type = changestate
value = 3020
triggerall = !AIlevel&&command = "burningslash"&&roundstate = 2 && statetype != A && power >= 1000
trigger1 = ctrl
trigger2 = (stateno = [200,419])&& movecontact
trigger3 = (stateno = [430,459])&& movecontact
;--------------------------------------------------------------------------------
...
type = changestate
value = 3010
triggerall = !AIlevel&&command = "burningattack"&&roundstate = 2 && statetype = A && power >= 1000
triggerall = !numhelper(3005) && !numhelper(3055)
trigger1 = ctrl
trigger2 = (stateno = [600,650])&&movecontact
;---------------------------------------------------------------------------
[State -1, finish buster]
type = changestate
value = 3000
triggerall = !AIlevel&&command = "burningattack"&&roundstate = 2 && statetype != A && power >= 1000
trigger1 = ctrl
...
;---------------------------------------------------------------------------
;
[State -1,  for master gohan AI]
type = ChangeState
value =1200
triggerall = AILevel&&roundstate=2&&statetype != A
triggerall=enemynear,Movetype!=A&&enemynear,Statetype!=L && random < (125 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[120,155])&&enemynear,statetype!=C
triggerall=(p2dist x=[90,220])&&(p2bodydist y=[-80,5])&&(enemynear,Stateno!=[5100,5250])
trigger1 = ctrl
...
value = 1300
triggerall = AILevel && roundstate=2&& Statetype != A
triggerall = P2movetype != A&&P2statetype != C&&(P2stateno!=[5100,5250])&&(P2stateno!=[120,155])
triggerall = (P2dist X=[10,80])&&(p2dist y=[-80,5])&&random < (200 * (AIlevel ** 2 / 64.0))
trigger1 = ctrl
trigger2 = (stateno = [200,250])&& movecontact
trigger3 = (stateno = [400,419])&& movecontact
trigger4 = (stateno = [430,449])&& movecontact
...
value = 1500
triggerall = AILevel&&roundstate = 2&&statetype != A
triggerall = p2movetype != A&&p2dist x <= 80&&(p2dist y=[-80,5])
triggerall =  p2dist x >= 30&&(p2stateno!= [120,150])&& random < (250 * (AIlevel ** 2 / 64.0))
trigger1 = ctrl
trigger2 = (stateno = [200,250])&& movecontact
trigger3 = (stateno = [400,420])&& movecontact
trigger4 = (stateno = [430,440])&& movecontact
;----------------------------------------------------------------------------------
[State -1, ]
type = changestate
value = 3000
...
triggerall=(p2dist x>=80)&&(p2dist y=[-60,5])&&random<150*(AIlevel ** 2 / 64.0)
trigger1 = ctrl
...
triggerall=(p2dist x=[5,90])&&(p2dist y=[-40,205])&&random<250*(AIlevel ** 2 / 64.0)&&Pos Y<=-40
trigger1 = ctrl
trigger2 = (stateno = [600,650])&&movecontact
;-------------------------------------------------------------------------
[State -1, ]
type = ChangeState
value = 3020
triggerall = AILevel && numenemy&&roundstate=2&&Statetype != A&&Power >= 1000&&var(25)=0
triggerall =(enemynear,stateno != [120, 155]) && (enemynear,p2stateno != [5120, 5250]) && (enemynear,statetype != C)  && (enemynear,statetype != L)&& (enemynear,Movetype != A)
triggerall =(p2dist x>= 30) && (p2dist y= [-80,0]) && (enemynear,statetype != L) && random < (275 * (AIlevel ** 2 / 64.0))
trigger1 = ctrl
trigger2 = (stateno = [200,450])&&anim!=255&&stateno!=420&&movecontact
;-------------------------------------------------------------------------
[State -1,]
