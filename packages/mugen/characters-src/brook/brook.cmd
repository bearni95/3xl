...
;   --- Uno Tag System [Type-S] Command definitions ---
...
triggerall = Partner, Time >= 150 && Time > 0
...
; ------ Uno Tag System [Type-S] END LINE -------
...
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
value = 691
triggerall = (command = "Counter") && (power >= 1500)
...
triggerall = var(59) != 0
triggerall = roundstate =2
triggerall = AIlevel > 2 || ((random < 250) && Time <= 15); Difficulty level
triggerall = AIlevel > 4 || ((random = [401,700]) && Time <= 10) ; Difficulty level
triggerall = AIlevel > 7 || ((random < 799) && Time <= 5)
triggerall = enemy,NumProj = [1000,1999]
...
triggerall = AIlevel > 2 || ((random < 250) && Time <= 15); Difficulty level
triggerall = AIlevel > 4 || ((random = [401,700]) && Time <= 10) ; Difficulty level
triggerall = AIlevel > 7 || ((random < 799) && Time <= 5) ; Difficulty level
trigger1 = statetype = A
ignorehitpause = 1
...
trigger2 = (stateno = [200,499]) || (stateno = [1000,1999])
