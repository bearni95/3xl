...
value = 400
triggerall = var(59) > 0
triggerall = random < (power/300)-life+p2life
...
;trigger1 = random < 20
;trigger2 = ctrl
;trigger2 = random = [300,p2life-life]
...
type = ChangeState
value = 230
triggerall = command = "goldenphoenix"
trigger1 = statetype != A
trigger1 = ctrl
