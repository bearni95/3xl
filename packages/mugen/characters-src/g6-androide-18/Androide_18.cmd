...
[State -1, Partner Assist Animation]
type = ChangeState
...
;triggerall = NumPartner
;triggerall = RoundState = 2
;triggerall = Partner, life > 0 && Power >= 3000
...
trigger1 = ctrl
trigger2 = command = "b" && (command = "holdfwd" || command = "holdback")
trigger2 = ctrl
...
[State -1, Special Counter]
type = ChangeState
triggerall = enemy,stateno != [3200,3300]
triggerall = StateNo != [3200,3300]
triggerall = numhelper(412) = 0
value = 410
