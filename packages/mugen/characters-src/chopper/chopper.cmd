...
trigger1 = stateno = 440 || stateno = 245 || stateno = 430
trigger1 = movecontact
...
triggerall = roundstate =2
triggerall = statetype = S
trigger1 =  stateno = 245 || stateno = 450
trigger1 = movecontact
...
triggerall = roundstate =2
triggerall = statetype = S
trigger1 =  stateno = 245 || stateno = 420
trigger1 = movecontact
...
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
value = 1230
triggerall = command = "06"||command = "07"||command = "08"
triggerall = statetype = a
trigger1 = ctrl
trigger2 = stateno = [600,699]
